...
from djmodels.contrib.auth.models import AbstractBaseUser
from djmodels.core.validators import RegexValidator, validate_slug
from djmodels.db import connection, models
from djmodels.db.migrations.autodetector import MigrationAutodetector
from djmodels.db.migrations.graph import MigrationGraph
from djmodels.db.migrations.loader import MigrationLoader
from djmodels.db.migrations.questioner import MigrationQuestioner
...
class AutodetectorTests(TestCase):
    ...
    @mock.patch('djmodels.db.migrations.questioner.MigrationQuestioner.ask_not_null_addition',
    ...
    @mock.patch('djmodels.db.migrations.questioner.MigrationQuestioner.ask_auto_now_add_addition')
    ...
    @mock.patch('djmodels.db.migrations.questioner.MigrationQuestioner.ask_not_null_alteration',
                side_effect=AssertionError("Should not have prompted for not null addition"))
    ...
    @mock.patch(
        'djmodels.db.migrations.questioner.MigrationQuestioner.ask_not_null_alteration',
    ...
    def test_rename_field_preserved_db_column(self):
        ...
        self.assertEqual(changes['app'][0].operations[-1].field.deconstruct(), (
            'renamed_field', 'djmodels.db.models.IntegerField', [], {'db_column': 'field'},
        ))
