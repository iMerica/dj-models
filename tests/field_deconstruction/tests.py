...
from djmodels.test.utils import isolate_lru_cache
...
class FieldDeconstructionTests(SimpleTestCase):
    ...
    def test_auto_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.AutoField")
        self.assertEqual(args, [])
    ...
    def test_big_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.BigIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_boolean_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.BooleanField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_csi_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.CommaSeparatedIntegerField")
        self.assertEqual(args, [])
    ...
    def test_email_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.EmailField")
        self.assertEqual(args, [])
    ...
    def test_file_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.FileField")
        self.assertEqual(args, [])
    ...
    def test_file_path_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.FilePathField")
        self.assertEqual(args, [])
    ...
    def test_float_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.FloatField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_foreign_key(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.ForeignKey")
        self.assertEqual(args, [])
    ...
    def test_one_to_one(self):
        ...
        field.remote_field.field_name = "id"
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.OneToOneField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {"to": "auth.Permission", "on_delete": models.CASCADE})
        self.assertFalse(hasattr(kwargs['to'], "setting_name"))
        # Test swap detection for swappable model
    ...
    def test_image_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.ImageField")
        self.assertEqual(args, [])
    ...
    def test_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.IntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_ip_address_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.IPAddressField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_generic_ip_address_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.GenericIPAddressField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_many_to_many_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.ManyToManyField")
        self.assertEqual(args, [])
    ...
    def test_null_boolean_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.NullBooleanField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_positive_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.PositiveIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_positive_small_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.PositiveSmallIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_slug_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.SlugField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_small_integer_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.SmallIntegerField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_text_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.TextField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_time_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.TimeField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_url_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.URLField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
    ...
    def test_binary_field(self):
        ...
        name, path, args, kwargs = field.deconstruct()
        self.assertEqual(path, "djmodels.db.models.BinaryField")
        self.assertEqual(args, [])
        self.assertEqual(kwargs, {})
