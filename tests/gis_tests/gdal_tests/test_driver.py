...
from djmodels.contrib.gis.gdal import Driver, GDALException
...
class DriverTest(unittest.TestCase):
    ...
    @mock.patch('djmodels.contrib.gis.gdal.driver.vcapi.get_driver_count')
    @mock.patch('djmodels.contrib.gis.gdal.driver.rcapi.get_driver_count')
    @mock.patch('djmodels.contrib.gis.gdal.driver.vcapi.register_all')
    @mock.patch('djmodels.contrib.gis.gdal.driver.rcapi.register_all')
