...
from djmodels.core.management import ManagementUtility
...
class BashCompletionTests(unittest.TestCase):
    ...
    def _user_input(self, input_str):
        ...
        $COMP_CWORD must be incremented by 1:
          ...
          * 'djmodels-admin start' -> COMP_CWORD=1
          * 'djmodels-admin startproject' -> COMP_CWORD=1
          * 'djmodels-admin startproject ' -> COMP_CWORD=2
        """
    ...
    def test_django_admin_py(self):
        ...
        self._user_input('djmodels-admin sqlmigrate --verb')
    ...
    def test_custom_command(self):
        ...
        self._user_input('djmodels-admin test_command --l')
        output = self._run_autocomplete()
        self.assertEqual(output, ['--list'])

    def test_subcommands(self):
        "Subcommands can be autocompleted"
        self._user_input('djmodels-admin sql')
        output = self._run_autocomplete()
    ...
    def test_completed_subcommand(self):
        ...
        self._user_input('djmodels-admin startproject ')  # Trailing whitespace
        output = self._run_autocomplete()
        for item in output:
    ...
    def test_help(self):
        ...
        self._user_input('djmodels-admin help --')
        output = self._run_autocomplete()
        self.assertEqual(output, [''])

    def test_app_completion(self):
        "Application names will be autocompleted for an AppCommand"
        self._user_input('djmodels-admin sqlmigrate a')
        output = self._run_autocomplete()
        a_labels = sorted(
