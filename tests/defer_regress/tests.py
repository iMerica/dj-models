...
from djmodels.contrib.sessions.backends.db import SessionStore
...
class DeferRegressionTest(TestCase):
    ...
    @override_settings(SESSION_SERIALIZER='djmodels.contrib.sessions.serializers.PickleSerializer')
