...
from djmodels.core.serializers import SerializerDoesNotExist
...
@override_settings(
    SERIALIZATION_MODULES={
        "json2": "djmodels.core.serializers.json",
    }
)
class SerializerRegistrationTests(SimpleTestCase):
    ...
    def test_register(self):
        ...
        serializers.register_serializer('json3', 'djmodels.core.serializers.json')
