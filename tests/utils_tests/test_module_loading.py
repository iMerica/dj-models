...
from djmodels.test import SimpleTestCase, TestCase, modify_settings
from djmodels.test.utils import extend_sys_path
from djmodels.utils.module_loading import (
...
class DefaultLoader(unittest.TestCase):
    ...
    def test_loader(self):
        ...
        self.assertFalse(module_has_submodule(test_module, 'djmodels'))
        with self.assertRaises(ImportError):
            import_module('utils_tests.test_module.djmodels')
...
class ModuleImportTestCase(TestCase):
    def test_import_string(self):
        cls = import_string('djmodels.utils.module_loading.import_string')
