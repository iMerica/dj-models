...
from djmodels.utils.lorem_ipsum import paragraph, paragraphs, sentence, words
...
class LoremIpsumTests(unittest.TestCase):
    ...
    @mock.patch('djmodels.utils.lorem_ipsum.random.sample')
    ...
    @mock.patch('djmodels.utils.lorem_ipsum.random.sample')
    @mock.patch('djmodels.utils.lorem_ipsum.random.choice')
    @mock.patch('djmodels.utils.lorem_ipsum.random.randint')
