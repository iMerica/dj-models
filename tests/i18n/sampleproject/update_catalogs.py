 ...
 * Run this script.
 * Test extraction - verify the new msgid in sampleproject's djmodels.po.
 * Add a translation to sampleproject's djmodels.po.
 * Run this script.
...
def update_translation_catalogs():
    ...
    pofile = os.path.join(proj_dir, 'locale', 'fr', 'LC_MESSAGES', 'djmodels.po')
