...
if "install" in sys.argv:
    ...
    for lib_path in lib_paths:
        existing_path = os.path.abspath(os.path.join(lib_path, "DJModels"))
...
setup(
    ...
    url='https://github.com/iMerica/dj-models',
    author='@iMerica',
    ...
    scripts=['djmodels/bin/django-admin.py'],
