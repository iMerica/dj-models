...
from djmodels.db.models.deletion import CASCADE, SET_DEFAULT, SET_NULL
...
class RelatedField(FieldCacheMixin, Field):
    ...
    def _check_clashes(self):
        ...
        from djmodels.db.models.base import ModelBase
...
class ForeignObject(RelatedField):
    ...
    def deconstruct(self):
        ...
        if swappable_setting is not None:
            ...
            # Set it
            from djmodels.db.migrations.writer import SettingsReference
